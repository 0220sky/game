...
let spaceshipxY = canvas.height - 64
...
function render(){
    ...
    ctx.drawImage(spaceshipImage, spaceshipX, spaceshipxY);
...
// 총알만들기
// 1. 스페이스 바를 누르면 총알 발사
// 2. 총알이 발사 = 총알의 y값이 --, 총알의 x값은? 스페이스를 누른 순의 우주선의 x좌표
...
// 총알.y <= 적군.y and 총알.x >= 적군.x and 총알.x <= 적군.x + 적군의 넓이 => 총알이 죽게됨, 적군의 우주선이 없어짐, 점수획득